...
function BestPage({ data }: { data: bestCreateDataType[] }) {
  ...
  return (
    <div className="flex flex-col w-full  h-auto relative pl-5 pr-10 ">
      <div
        className={` absolute pr-10 top-0 left-5 right-0 z-20 whitespace-nowrap overflow-x-hidden  ${isOpen ? 'bg-white' : ''}`}

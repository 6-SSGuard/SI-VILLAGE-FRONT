    ...
    return (
        ...
        <div className="m-2 mr-2 ml-6 w-full h-full flex flex-row flex-wrap">
            ...
            <Image src = "/beauty.png"
                    alt="beauty" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
            ...
            <Image src = "/man.png"
                    alt="man" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
            ...
            <Image src = "/bag.png"
                    alt="bag" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
            ...
            <Image src = "/shose.png"
                    alt="shose" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
            ...
            <Image src = "/ak.png"
                    alt="ak" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
            ...
            <Image src = "/sport.png"
                    alt="sport" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
                 
                <span className="text-xs font-bold">스포츠/<br/>레저</span>
            </Link>
            </div>
            ...
            <Image src = "/life.png"
                    alt="life" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
            ...
            <Image src = "/JAJU.png"
                    alt="JAJU" width={16} height = {16} className="w-16 h-16 bg-blue-300 rounded-full">
                    </Image>
